...
| Initial Complete Scope end-to-end workflow | 93% | 進行中 |
...
| 1.5 | Schema Registry and Validation | 73% | 進行中 | `6e9bc7b`, `e11e947`, `414e79d`, `c9e8f76`, `402d04a` | schema validation対象の拡張へ進む |
